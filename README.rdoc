...
Make an example query (note the version), {similar to those in Clockwork}[https://github.com/justworkshr/clockwork_web/blob/85e815d1e43294aceef8229df89f63888804bb7f/lib/batch_runner/salesforce_leads_sync_batch_runner.rb#L7-L23]:
